...
"""Verify that starting gainproxd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gainproxd with -h for help text")
        ...
        self.log.info("Start gainproxd with -version for version information")
