...
from test_framework.test_framework import GainproxTestFramework
...
class LLMQChainLocksTest(GainproxTestFramework):
    def set_test_params(self):
        self.set_gainprox_test_params(6, 5, fast_dip3_enforcement=True)
