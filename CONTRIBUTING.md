Contributing to Gainprox Core
============================

The Gainprox Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/gprotocolx/gainprox/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Gainprox Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Gainprox
Network Protocol consensus changes.

Whether a pull request is merged into Gainprox Core rests with the project merge
...
Patches that change Gainprox consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gainprox consensus, it must have been
...
The review process is normally fairly responsive on the Gainprox Core repository, however
...
The project leader is the release manager for each Gainprox Core release.
