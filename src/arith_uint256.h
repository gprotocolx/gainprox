...
#ifndef GAINPROX_ARITH_UINT256_H
#define GAINPROX_ARITH_UINT256_H
...
public:
     ...
     *
     * Gainprox only uses this "compact" format for encoding difficulty
...
#endif // GAINPROX_ARITH_UINT256_H
