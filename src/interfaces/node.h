...
//! Interface for the src/evo part of a gainprox node (gainproxd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a gainprox node (gainproxd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a gainprox node (gainproxd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a gainprox node (gainproxd process).
class Node
{
public:
    virtual ~Node() {}
