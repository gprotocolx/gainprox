...
{
    const char* pszTimestamp = "Gain Protocol X 4/April/2023 GhostRider GAINPROX for protocol Blockchain";
    const CScript genesisOutputScript = CScript() << ParseHex("0471b6abab42e6df8e8fb62e23e46555bc2d4471db60660007ee7b209d7d67ef1c3ac3e5cd9e021f1704c050d5b732eaf66733024b83fea81dc7b053e5d2c54e7a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2 * 60; // Gainprox: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x00016440b6eb77287fbcc897a1c4a603090c0141805cc0a37c6c31cea609b9a96"); // 0
        ...
        vSeeds.emplace_back("x1.gainprox.com");
        vSeeds.emplace_back("x2.gainprox.com");
        vSeeds.emplace_back("x3.gainprox.com");
        vSeeds.emplace_back("s1.gainprox.com");
        vSeeds.emplace_back("e2.gainprox.com");
        vSeeds.emplace_back("f3.gainprox.com");



        // Gainprox addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Gainprox script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Gainprox private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Gainprox BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Gainprox BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Gainprox BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"Ge5WEo146mHSkjtZdr458cTN5DQeHH83yR"};
        nMinSporkKeys = 1;
