    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  gainprox-qt [command-line options]                     \n";
...
All the Gainprox in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 GPRX, 0.01 GPRX, 0.1 GPRX, 1 GPRX and 10 GPRX -- sort of like the paper money you use every day.</li> \
