...
/** Utility functions used by the Gainprox Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gainprox:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load gainprox specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a gainprox specific theme is activated (light/dark).*/
