...
rm -f src/config/gainprox-config.h
...
rm -rf test_bitcoin.coverage/ gainprox-gtest.coverage/ total.coverage/
...
clean_exe src/gainprox-cli
clean_exe src/gainproxd
clean_exe src/gainprox-gtest
clean_exe src/gainprox-tx
clean_exe src/test/test_gainprox
clean_exe src/test/test_gainprox_fuzzy
...
clean_dep . src/config/gainprox-config.h.in
