...
* gainprox.conf: contains configuration settings for gainproxd or gainprox-qt
* gainproxd.pid: stores the process id of gainproxd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by gainproxd or gainprox-qt
