...
This mechanism has been integrated into Bitcore-Node-Gainprox which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gprotocolx/insight-api-gainprox#web-socket-api](https://github.com/gprotocolx/insight-api-gainprox#web-socket-api)
* API: [https://github.com/gprotocolx/insight-api-gainprox#instantsend-transactions](https://github.com/gprotocolx/insight-api-gainprox#instantsend-transactions)
